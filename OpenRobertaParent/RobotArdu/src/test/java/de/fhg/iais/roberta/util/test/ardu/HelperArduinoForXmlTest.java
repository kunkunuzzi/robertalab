    ...
    public HelperArduinoForXmlTest() {
        super(
            ...
            new ArduinoConfiguration.Builder()
                ...
                .addConfigurationBlock(new ConfigurationBlock(ConfigurationBlockType.LCD), "LCD", null, new ArrayList<String>() {
                    {
                        add("12");
                        add("11");
                        add("5");
                ...
                .addConfigurationBlock(new ConfigurationBlock(ConfigurationBlockType.LCDI2C), "LCD", null, null)
